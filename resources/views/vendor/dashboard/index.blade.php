...
<div class="row g-4 mb-4">
    <div class="col-sm-6 col-xl-3">
        <div class="card stat-card p-3">
            <div class="d-flex align-items-center gap-3">
                <div class="icon-box bg-primary bg-opacity-10 text-primary"><i class="bi bi-p-square-fill"></i></div>
                <div>
                    <div class="text-muted small">My Parkings</div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card stat-card p-3">
            <div class="d-flex align-items-center gap-3">
                <div class="icon-box bg-success bg-opacity-10 text-success"><i class="bi bi-grid-fill"></i></div>
                <div>
                    <div class="text-muted small">Total Spots</div>
                    <div class="fw-bold fs-4">{{ number_format($stats['total_spots']) }}</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card stat-card p-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <div class="text-muted small">My Revenue</div>
...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body p-0">
        <table class="table table-hover mb-0" id="recentTable" style="width:100%">
            <thead>
                <tr>
                    <th>#ID</th><th>Customer</th><th>Parking</th><th>Spot</th>
...
$('#recentTable').DataTable({
    ...
    info: false,
    order: [],
    language: { emptyTable: 'No bookings yet.' }
});
</script>
@endpush
